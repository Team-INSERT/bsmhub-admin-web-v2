...
export const StudentUniversity = ({
  datas,
}: {
  datas: UserDetailType['student_universities']
}) => {
        ...
        <dl className='space-y-2'>
          <div className='flex gap-2'>
            {datas.length > 0 ? (
              ...
              <>
                <dt className='w-24 flex-shrink-0 font-medium'>진학여부:</dt>
                <dd>아니오</dd>
              </>
            )}
          </div>
          {datas.map(({ universities }) => (
            <>
              ...
              <div className='flex gap-2'>
                <dt className='w-24 flex-shrink-0 font-medium'>학과명:</dt>
